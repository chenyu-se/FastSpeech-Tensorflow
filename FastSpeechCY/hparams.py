...
hparams = tf.contrib.training.HParams(
	...
	freq_axis_kernel_size = 3, #Only used for 2D upsampling. This is the number of frequency bands that are spanned at a time for each frame.
	...
	n_speakers = 1, #number of speakers (rows of the embedding)
	...
	max_time_steps = 8000, #Max time steps in audio used to train wavenet (decrease to save memory) (Recommend: 8000 on modest GPUs, 13000 on stronger ones)  11000
	###########################################################################################################################################
	...
	tacotron_batch_size = 4, #number of training samples on each training steps        GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG32
	...
	tacotron_start_decay = 500, #Step at which learning decay starts           GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG50000
	tacotron_decay_steps = 500, #Determines the learning rate decay slope (UNDER TEST)     GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG50000
