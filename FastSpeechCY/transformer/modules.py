...
'''def ff(inputs, num_units, scope="positionwise_feedforward", is_training=True):
...
class Postnet:
	...
	def __init__(self, is_training, 
		...
		self.kernel_size = 5        
		self.channels, self.mel_channels = postnet_embedding_dim, n_mel_channels
	...
	def __call__(self, inputs):
		with tf.variable_scope(self.scope):
			...
			x = conv1d(x, self.kernel_size, self.mel_channels, lambda _: _, self.is_training, self.drop_rate,
