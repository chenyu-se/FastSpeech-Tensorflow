...
class Hparams:
    ...
    # training scheme
    parser.add_argument('--batch_size', default=2, type=int)                 #default = 128
    ...
    # model
    parser.add_argument('--d_model', default=384, type=int,                 #default = 512
                        help="hidden dimension of encoder/decoder")
    parser.add_argument('--d_ff', default=2048, type=int,                   #default = 2048
                        help="hidden dimension of feedforward layer")
    parser.add_argument('--num_blocks', default=6, type=int,
                        help="number of encoder/decoder blocks")
    parser.add_argument('--num_heads', default=2, type=int,                 #defualt = 8
                        help="number of attention heads")
    parser.add_argument('--maxlen1', default=2048, type=int,                 #default = 100
                        help="maximum length of a source sequence")
    parser.add_argument('--maxlen2', default=2048, type=int,                 #default = 100
